...
knittingtime7 = KnittingTime.create(date: '2018-12-29', start_time: '5 PM', end_time: '6 PM', address_1: '21st St' , city: 'Sacramento' , state: 'CA', zip: '95811', area_id: area4.id , host_id: user8.id, description: "I love talk about travel, good books and passion projects individuals might be working on. I am also an introvert and enjoy learning from others how to cut through the small talk.")

knittingtime8 = KnittingTime.create(date: '2018-12-30', start_time: '10 PM', end_time: '12 PM', address_1: '5000 Toronto Way' , city: 'Sacramento' , state: 'CA', zip: '95820', area_id: area4.id , host_id: user6.id, description: "Values. Not like 'I value honesty / integrity / justice.' More like stories that are a reflection of our values, who we truly are and who we aspire to be. Values aside, we could probably get into any of the following as well: Buddy the Elf / salsa dancing / best places to surf & climb / thought-provoking books & documentaries / animosity towards Microsoft Office / travel adventures / when things go wrong (i.e. that time I was very alone in a dark alley in a coastal Kenyan town) / when things go right (that time in that dark alley when a gang of teen-aged strangers helped me find my way home) / matzo ball soup.")

knittingtime9 = KnittingTime.create(date: '2018-12-10', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: "Coincidences, future, connections, lost & found, dreams interpretation, challenges, secrets, tips on how to behave-survive in a big city, events, theatre, inspiring people, family mania, friends craziness and more…")

knittingtime10 = KnittingTime.create(date: '2018-11-09', start_time: '3 PM', end_time: '5 PM', address_1: '5218 Javier St' , city: 'San Diego' , state: 'CA', zip: '92117', area_id: area3.id , host_id: user5.id, description: "Whatever you want! Missed connections, food inspiration, hidden talents, random observations, rogue family members, the best city spots, everyday challenges, your quirks, lifestyle, art house cinema, adventures, stories from your travels, failed attempts, events, random trivia, Toronto street style, books you've read, my love of salsa dancing, our goals and dreams, your childhood best friend, and of course your deepest secrets ;). Or none of these. There’s almost no topic or theme that’s off the table!")


knittingtime11 = KnittingTime.create(date: '2019-01-30', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: "Coincidences, future, connections, lost & found, dreams interpretation, challenges, secrets, tips on how to behave-survive in a big city, events, theatre, inspiring people, family mania, friends craziness and more…")

knittingtime12 = KnittingTime.create(date: '2019-01-26', start_time: '5 PM', end_time: '7 PM', address_1: '940 Filbert St' , city: 'San Francisco', state: 'CA', zip:'94133', area_id: area1.id, host_id: user2.id, description: "Spread your knowledge! Teach me something new you learned today or something you're super passionate about. Let's have a debate about politics or about why cheesy snacks are better in the US than in the UK. Nothing's off the table, except the weather or which public transit route you took to get here.")

knittingtime13 = KnittingTime.create(date: '2019-01-01', start_time: '6 PM', end_time: '8 PM', address_1: '8645 S Sepulveda Blvd' , city: 'Westchester' , state: 'CA', zip: '90045', area_id: area2.id , host_id: user3.id, description: "We can talk about life, cats, animals, startups, technology, tea, coffee, music, art, programming, web design, the best way to cook vegetables, great events in London, famous people, interesting people, people I still have to meet, art exhibitions, happy things, sad things, learning italiano, other planets and far-away galaxies.")

knittingtime14 = KnittingTime.create(date: '2019-01-28', start_time: '1 PM', end_time: '3 PM', address_1: '2316 Camden Ave' , city: 'Los Angeles' , state: 'CA', zip: '90064', area_id: area2.id , host_id: user4.id, description: "Photography, DDR, Literally anything gaming related, COD4, Hot Sauces, Go-To Recipes, Music Playlists (exercising especially), Passions, A.I., Media Recommendations, DIY projects, Handball, Tea, Online Articles, Board Games, the Oxford Comma Debate, Personal Goals, Subreddits, YouTube Channels, UBI, “Deep” questions, Favorite Exercises (DEADLIFT FTW), Cultures, Quirks, Upcoming trips, Upcoming Challenges, Mental health, Uplifting news...AND MORE!")

knittingtime15 = KnittingTime.create(date: '2019-01-25', start_time: '3 PM', end_time: '5 PM', address_1: '5218 Javier St' , city: 'San Diego' , state: 'CA', zip: '92117', area_id: area3.id , host_id: user5.id, description: "Whatever you want! Missed connections, food inspiration, hidden talents, random observations, rogue family members, the best city spots, everyday challenges, your quirks, lifestyle, art house cinema, adventures, stories from your travels, failed attempts, events, random trivia, Toronto street style, books you've read, my love of salsa dancing, our goals and dreams, your childhood best friend, and of course your deepest secrets ;). Or none of these. There’s almost no topic or theme that’s off the table!")

knittingtime16 = KnittingTime.create(date: '2019-01-10', start_time: '6 PM', end_time: '8 PM', address_1: '816 22nd St' , city: 'Riverside' , state: 'CA', zip: '95816', area_id: area5.id , host_id: user7.id, description: "Currently, I am super interested in how people interact with the relationships (friendships, romantic relationships, relationships with relatives etc) in their lives, so I might ask you questions like: what’s been the most influential relationship you’ve had? How do you determine what a good relationship is for yourself? (remember what I said about questions that are maybe a bit too much for normal conversation?)
Really, I’m game to talk about anything (especially things that have no answer and are difficult to understand) so please come with all the questions you’ve ever wanted to ask a stranger and all the things you ever wanted to share.
(Otherwise, I’m not the best at small talk, so if you reaaaallly wanted to talk about the weather, I’m sure I could use some practice…)
See ya!")

knittingtime17 = KnittingTime.create(date: '2019-01-29', start_time: '5 PM', end_time: '6 PM', address_1: '21st St' , city: 'Sacramento' , state: 'CA', zip: '95811', area_id: area4.id , host_id: user8.id, description: "I love talk about travel, good books and passion projects individuals might be working on. I am also an introvert and enjoy learning from others how to cut through the small talk.")

knittingtime18 = KnittingTime.create(date: '2019-01-30', start_time: '10 PM', end_time: '12 PM', address_1: '5000 Toronto Way' , city: 'Napa Valley' , state: 'CA', zip: '95820', area_id: area6.id , host_id: user6.id, description: "Values. Not like 'I value honesty / integrity / justice.' More like stories that are a reflection of our values, who we truly are and who we aspire to be. Values aside, we could probably get into any of the following as well: Buddy the Elf / salsa dancing / best places to surf & climb / thought-provoking books & documentaries / animosity towards Microsoft Office / travel adventures / when things go wrong (i.e. that time I was very alone in a dark alley in a coastal Kenyan town) / when things go right (that time in that dark alley when a gang of teen-aged strangers helped me find my way home) / matzo ball soup.")

knittingtime19 = KnittingTime.create(date: '2019-01-10', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: "Coincidences, future, connections, lost & found, dreams interpretation, challenges, secrets, tips on how to behave-survive in a big city, events, theatre, inspiring people, family mania, friends craziness and more…")

knittingtime20 = KnittingTime.create(date: '2019-12-09', start_time: '3 PM', end_time: '5 PM', address_1: '5218 Javier St' , city: 'San Joaquin Valley' , state: 'CA', zip: '92117', area_id: area7.id , host_id: user5.id, description: "Whatever you want! Missed connections, food inspiration, hidden talents, random observations, rogue family members, the best city spots, everyday challenges, your quirks, lifestyle, art house cinema, adventures, stories from your travels, failed attempts, events, random trivia, Toronto street style, books you've read, my love of salsa dancing, our goals and dreams, your childhood best friend, and of course your deepest secrets ;). Or none of these. There’s almost no topic or theme that’s off the table!")
...
enrollment33 = KnittingTimeEnrollment.create(user_id: user5.id, knittingtime_id: knittingtime7.id, going: true)
...
enrollment33 = KnittingTimeEnrollment.create(user_id: user9.id, knittingtime_id: knittingtime11.id, going: true)
enrollment32 = KnittingTimeEnrollment.create(user_id: user10.id, knittingtime_id: knittingtime11.id, going: true)
enrollment33 = KnittingTimeEnrollment.create(user_id: user11.id, knittingtime_id: knittingtime11.id, going: true)
enrollment35 = KnittingTimeEnrollment.create(user_id: user12.id, knittingtime_id: knittingtime11.id, going: true)
enrollment36 = KnittingTimeEnrollment.create(user_id: user13.id, knittingtime_id: knittingtime11.id, going: false)

enrollment37 = KnittingTimeEnrollment.create(user_id: user14.id, knittingtime_id: knittingtime12.id, going: true)
enrollment38 = KnittingTimeEnrollment.create(user_id: user15.id, knittingtime_id: knittingtime12.id, going: true)
enrollment39 = KnittingTimeEnrollment.create(user_id: user16.id, knittingtime_id: knittingtime12.id, going: true)

enrollment40 = KnittingTimeEnrollment.create(user_id: user17.id, knittingtime_id: knittingtime13.id, going: true)
enrollment41 = KnittingTimeEnrollment.create(user_id: user18.id, knittingtime_id: knittingtime13.id, going: true)
enrollment42 = KnittingTimeEnrollment.create(user_id: user19.id, knittingtime_id: knittingtime13.id, going: true)
enrollment43 = KnittingTimeEnrollment.create(user_id: user20.id, knittingtime_id: knittingtime13.id, going: true)

enrollment44 = KnittingTimeEnrollment.create(user_id: user21.id, knittingtime_id: knittingtime14.id, going: true)
enrollment45 = KnittingTimeEnrollment.create(user_id: user22.id, knittingtime_id: knittingtime14.id, going: true)
enrollment46 = KnittingTimeEnrollment.create(user_id: user23.id, knittingtime_id: knittingtime14.id, going: true)
enrollment47 = KnittingTimeEnrollment.create(user_id: user24.id, knittingtime_id: knittingtime14.id, going: true)
enrollment48 = KnittingTimeEnrollment.create(user_id: user25.id, knittingtime_id: knittingtime14.id, going: true)

enrollment49 = KnittingTimeEnrollment.create(user_id: user26.id, knittingtime_id: knittingtime15.id, going: true)
enrollment50 = KnittingTimeEnrollment.create(user_id: user27.id, knittingtime_id: knittingtime15.id, going: true)

enrollment51 = KnittingTimeEnrollment.create(user_id: user28.id, knittingtime_id: knittingtime16.id, going: true)
enrollment52 = KnittingTimeEnrollment.create(user_id: user29.id, knittingtime_id: knittingtime16.id, going: true)
enrollment53 = KnittingTimeEnrollment.create(user_id: user5.id, knittingtime_id: knittingtime16.id, going: true)

enrollment54 = KnittingTimeEnrollment.create(user_id: user30.id, knittingtime_id: knittingtime17.id, going: true)
enrollment55 = KnittingTimeEnrollment.create(user_id: user31.id, knittingtime_id: knittingtime17.id, going: true)
enrollment56 = KnittingTimeEnrollment.create(user_id: user32.id, knittingtime_id: knittingtime17.id, going: true)
enrollment57 = KnittingTimeEnrollment.create(user_id: user5.id, knittingtime_id: knittingtime17.id, going: true)

enrollment58 = KnittingTimeEnrollment.create(user_id: user33.id, knittingtime_id: knittingtime18.id, going: true)
enrollment59 = KnittingTimeEnrollment.create(user_id: user5.id, knittingtime_id: knittingtime18.id, going: true)

enrollment60 = KnittingTimeEnrollment.create(user_id: user5.id, knittingtime_id: knittingtime19.id, going: true)
enrollment61 = KnittingTimeEnrollment.create(user_id: user10.id, knittingtime_id: knittingtime19.id, going: true)
enrollment62 = KnittingTimeEnrollment.create(user_id: user11.id, knittingtime_id: knittingtime19.id, going: true)
enrollment63 = KnittingTimeEnrollment.create(user_id: user12.id, knittingtime_id: knittingtime19.id, going: true)
enrollment64 = KnittingTimeEnrollment.create(user_id: user13.id, knittingtime_id: knittingtime19.id, going: true)
