...
knittingtime1 = KnittingTime.create(date: '2018-10-30', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: "Coincidences, future, connections, lost & found, dreams interpretation, challenges, secrets, tips on how to behave-survive in a big city, events, theatre, inspiring people, family mania, friends craziness and more…")

knittingtime2 = KnittingTime.create(date: '2018-10-26', start_time: '5 PM', end_time: '7 PM', address_1: '940 Filbert St' , city: 'San Francisco', state: 'CA', zip:'94133', area_id: area1.id, host_id: user2.id, description: "Spread your knowledge! Teach me something new you learned today or something you're super passionate about. Let's have a debate about politics or about why cheesy snacks are better in the US than in the UK. Nothing's off the table, except the weather or which public transit route you took to get here.")
...
knittingtime4 = KnittingTime.create(date: '2018-10-28', start_time: '1 PM', end_time: '3 PM', address_1: '2316 Camden Ave' , city: 'Los Angeles' , state: 'CA', zip: '90064', area_id: area2.id , host_id: user4.id, description: "Photography, DDR, Literally anything gaming related, COD4, Hot Sauces, Go-To Recipes, Music Playlists (exercising especially), Passions, A.I., Media Recommendations, DIY projects, Handball, Tea, Online Articles, Board Games, the Oxford Comma Debate, Personal Goals, Subreddits, YouTube Channels, UBI, “Deep” questions, Favorite Exercises (DEADLIFT FTW), Cultures, Quirks, Upcoming trips, Upcoming Challenges, Mental health, Uplifting news...AND MORE!")

knittingtime5 = KnittingTime.create(date: '2018-10-10', start_time: '3 PM', end_time: '5 PM', address_1: '5218 Javier St' , city: 'San Diego' , state: 'CA', zip: '92117', area_id: area3.id , host_id: user5.id, description: "Whatever you want! Missed connections, food inspiration, hidden talents, random observations, rogue family members, the best city spots, everyday challenges, your quirks, lifestyle, art house cinema, adventures, stories from your travels, failed attempts, events, random trivia, Toronto street style, books you've read, my love of salsa dancing, our goals and dreams, your childhood best friend, and of course your deepest secrets ;). Or none of these. There’s almost no topic or theme that’s off the table!")

knittingtime6 = KnittingTime.create(date: '2018-11-10', start_time: '6 PM', end_time: '8 PM', address_1: '816 22nd St' , city: 'Sacramento' , state: 'CA', zip: '95816', area_id: area4.id , host_id: user7.id, description: "Currently, I am super interested in how people interact with the relationships (friendships, romantic relationships, relationships with relatives etc) in their lives, so I might ask you questions like: what’s been the most influential relationship you’ve had? How do you determine what a good relationship is for yourself? (remember what I said about questions that are maybe a bit too much for normal conversation?)
...
knittingtime7 = KnittingTime.create(date: '2018-10-29', start_time: '5 PM', end_time: '6 PM', address_1: '21st St' , city: 'Sacramento' , state: 'CA', zip: '95811', area_id: area4.id , host_id: user8.id, description: "I love talk about travel, good books and passion projects individuals might be working on. I am also an introvert and enjoy learning from others how to cut through the small talk.")

knittingtime8 = KnittingTime.create(date: '2018-10-30', start_time: '10 PM', end_time: '12 PM', address_1: '5000 Toronto Way' , city: 'Sacramento' , state: 'CA', zip: '95820', area_id: area4.id , host_id: user6.id, description: "Values. Not like 'I value honesty / integrity / justice.' More like stories that are a reflection of our values, who we truly are and who we aspire to be. Values aside, we could probably get into any of the following as well: Buddy the Elf / salsa dancing / best places to surf & climb / thought-provoking books & documentaries / animosity towards Microsoft Office / travel adventures / when things go wrong (i.e. that time I was very alone in a dark alley in a coastal Kenyan town) / when things go right (that time in that dark alley when a gang of teen-aged strangers helped me find my way home) / matzo ball soup.")

knittingtime9 = KnittingTime.create(date: '2018-10-10', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: "Coincidences, future, connections, lost & found, dreams interpretation, challenges, secrets, tips on how to behave-survive in a big city, events, theatre, inspiring people, family mania, friends craziness and more…")
