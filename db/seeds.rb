...
knittingtime7 = KnittingTime.create(date: '2018-11-29', start_time: '5 PM', end_time: '6 PM', address_1: '21st St' , city: 'Sacramento' , state: 'CA', zip: '95811', area_id: area4.id , host_id: user8.id, description: "I love talk about travel, good books and passion projects individuals might be working on. I am also an introvert and enjoy learning from others how to cut through the small talk.")

knittingtime8 = KnittingTime.create(date: '2018-11-30', start_time: '10 PM', end_time: '12 PM', address_1: '5000 Toronto Way' , city: 'Sacramento' , state: 'CA', zip: '95820', area_id: area4.id , host_id: user6.id, description: "Values. Not like 'I value honesty / integrity / justice.' More like stories that are a reflection of our values, who we truly are and who we aspire to be. Values aside, we could probably get into any of the following as well: Buddy the Elf / salsa dancing / best places to surf & climb / thought-provoking books & documentaries / animosity towards Microsoft Office / travel adventures / when things go wrong (i.e. that time I was very alone in a dark alley in a coastal Kenyan town) / when things go right (that time in that dark alley when a gang of teen-aged strangers helped me find my way home) / matzo ball soup.")

knittingtime9 = KnittingTime.create(date: '2018-11-10', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: "Coincidences, future, connections, lost & found, dreams interpretation, challenges, secrets, tips on how to behave-survive in a big city, events, theatre, inspiring people, family mania, friends craziness and more…")

knittingtime10 = KnittingTime.create(date: '2018-10-09', start_time: '3 PM', end_time: '5 PM', address_1: '5218 Javier St' , city: 'San Diego' , state: 'CA', zip: '92117', area_id: area3.id , host_id: user5.id, description: "Whatever you want! Missed connections, food inspiration, hidden talents, random observations, rogue family members, the best city spots, everyday challenges, your quirks, lifestyle, art house cinema, adventures, stories from your travels, failed attempts, events, random trivia, Toronto street style, books you've read, my love of salsa dancing, our goals and dreams, your childhood best friend, and of course your deepest secrets ;). Or none of these. There’s almost no topic or theme that’s off the table!")
