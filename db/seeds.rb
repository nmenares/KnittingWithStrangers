...
KnittingTime.create(date: '2018-08-08', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: 'Contrary' )

KnittingTime.create(date: '2018-08-12', start_time: '6 PM', end_time: '8 PM', address_1: '38 Frontenac Ave' , city: 'North York' , state: 'ON', zip: 'M5N 1Z7', area_id: area5.id , host_id: user4.id, description: 'Contrary' )

KnittingTime.create(date: '2018-08-20', start_time: '5 PM', end_time: '7 PM', address_1: '825 Battery Street' , city: 'San Francisco', state: 'CA', zip:'94111', area_id: area1.id, host_id: user1.id, description: 'Contrary' )
