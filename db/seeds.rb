...
knittingtime7 = KnittingTime.create(date: '2018-09-27', start_time: '5 PM', end_time: '6 PM', address_1: '21st St' , city: 'Sacramento' , state: 'CA', zip: '95811', area_id: area4.id , host_id: user8.id, description: "I love talk about travel, good books and passion projects individuals might be working on. I am also an introvert and enjoy learning from others how to cut through the small talk.")
...
enrollment1 = KnittingTimeEnrollment.create(user_id: user9.id, knittingtime_id: knittingtime1.id)
enrollment2 = KnittingTimeEnrollment.create(user_id: user10.id, knittingtime_id: knittingtime1.id)
enrollment3 = KnittingTimeEnrollment.create(user_id: user11.id, knittingtime_id: knittingtime1.id)
enrollment4 = KnittingTimeEnrollment.create(user_id: user12.id, knittingtime_id: knittingtime1.id)
enrollment5 = KnittingTimeEnrollment.create(user_id: user13.id, knittingtime_id: knittingtime1.id)

enrollment6 = KnittingTimeEnrollment.create(user_id: user14.id, knittingtime_id: knittingtime2.id)
enrollment7 = KnittingTimeEnrollment.create(user_id: user15.id, knittingtime_id: knittingtime2.id)
enrollment8 = KnittingTimeEnrollment.create(user_id: user16.id, knittingtime_id: knittingtime2.id)

enrollment9 = KnittingTimeEnrollment.create(user_id: user17.id, knittingtime_id: knittingtime3.id)
enrollment10 = KnittingTimeEnrollment.create(user_id: user18.id, knittingtime_id: knittingtime3.id)
enrollment11 = KnittingTimeEnrollment.create(user_id: user19.id, knittingtime_id: knittingtime3.id)
enrollment12 = KnittingTimeEnrollment.create(user_id: user20.id, knittingtime_id: knittingtime3.id)

enrollment13 = KnittingTimeEnrollment.create(user_id: user21.id, knittingtime_id: knittingtime4.id)
enrollment14 = KnittingTimeEnrollment.create(user_id: user22.id, knittingtime_id: knittingtime4.id)
enrollment15 = KnittingTimeEnrollment.create(user_id: user23.id, knittingtime_id: knittingtime4.id)
enrollment16 = KnittingTimeEnrollment.create(user_id: user24.id, knittingtime_id: knittingtime4.id)
enrollment17 = KnittingTimeEnrollment.create(user_id: user25.id, knittingtime_id: knittingtime4.id)

enrollment18 = KnittingTimeEnrollment.create(user_id: user26.id, knittingtime_id: knittingtime5.id)
enrollment19 = KnittingTimeEnrollment.create(user_id: user27.id, knittingtime_id: knittingtime5.id)

enrollment20 = KnittingTimeEnrollment.create(user_id: user28.id, knittingtime_id: knittingtime6.id)
enrollment21 = KnittingTimeEnrollment.create(user_id: user29.id, knittingtime_id: knittingtime6.id)

enrollment22 = KnittingTimeEnrollment.create(user_id: user30.id, knittingtime_id: knittingtime7.id)
enrollment23 = KnittingTimeEnrollment.create(user_id: user31.id, knittingtime_id: knittingtime7.id)
enrollment24 = KnittingTimeEnrollment.create(user_id: user32.id, knittingtime_id: knittingtime7.id)

enrollment25 = KnittingTimeEnrollment.create(user_id: user33.id, knittingtime_id: knittingtime8.id)
